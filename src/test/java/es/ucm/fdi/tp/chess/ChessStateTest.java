...
public class ChessStateTest {
    ...
    public void testThreats() {
        ...
        assertTrue("white pawn threatens diagonals",
        		 ChessState.threatenedBy(cs.getChessBoard(), WHITE, 3, 3));
        assertTrue("white pawn threatens diagonals",
        		ChessState.threatenedBy(cs.getChessBoard(), WHITE, 3, 5));
        assertTrue("black pawn threatens diagonals",
        		ChessState.threatenedBy(cs.getChessBoard(), BLACK, 3, 4));
        assertTrue("black pawn threatens diagonals",
        		ChessState.threatenedBy(cs.getChessBoard(), BLACK, 3, 6));
        assertTrue("white queen threatens diagonals",
        		ChessState.threatenedBy(cs.getChessBoard(), WHITE, 3, 7));
        assertTrue("others unthreatened 1",
                !ChessState.threatenedBy(cs.getChessBoard(), WHITE, 4, 0));
        assertTrue("others unthreatened 2",
                !ChessState.threatenedBy(cs.getChessBoard(), BLACK, 5, 0));
    }
    ...
    public void testEnPassant() {
        ...
        assertTrue("Capturing pawn ok", cs.getChessBoard().get(2, 5)
                == ChessBoard.Piece.Pawn.white());
        assertTrue("Captured pawn now gone", cs.getChessBoard().get(3, 5)
                == ChessBoard.EMPTY);
    }
    ...
    public void testCastling() {
        ...
        ChessBoard board = cs.getChessBoard();
    ...
    public void testMovesAvoidCheck() {
        ...
        assertTrue("king at 2,5 would be eaten",
                ChessState.threatenedBy(cs.getChessBoard(), WHITE, 2, 5));
